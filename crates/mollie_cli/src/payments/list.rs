...
pub async fn command(config: &MollieConfig, limit: &Option<i32>, from: &Option<String>, profile_id: &Option<String>, test_mode: &Option<bool>, with_response: bool, status: &Option<Status>)-> anyhow::Result<()> {
...
fn list_payments_from_response(response: mollie_api::models::payment::PaymentsListResource, with_response: bool, status: &Option<Status>) {
